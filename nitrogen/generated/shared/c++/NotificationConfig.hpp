...
namespace margelo::nitro::audioanvil {
  ...
  public:
    ...
    explicit NotificationConfig(std::string title, std::string text): title(title), text(text) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::audioanvil::NotificationConfig> final {
    static inline margelo::nitro::audioanvil::NotificationConfig fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::audioanvil::NotificationConfig(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::audioanvil::NotificationConfig& arg) {
